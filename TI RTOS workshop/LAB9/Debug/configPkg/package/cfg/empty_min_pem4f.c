 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/csxwin/workspace_v6.1.2/LAB9/Debug/configPkg/package/cfg/empty_min_pem4f");
...
ti_sysbios_knl_Task_Object__ ti_sysbios_knl_Task_Object__table__V[2] = {
    {/* instance#0 */
        ...
        (xdc_UInt)0x0,  /* affinity */
        (xdc_runtime_Text_CordAddr)(xdc_runtime_Text_charTab__A+8033) /* __name */
    },
    {/* instance#1 */
        {
        ...
        (xdc_UInt)0x0,  /* curCoreId */
        (xdc_UInt)0x0,  /* affinity */
        (xdc_runtime_Text_CordAddr)(xdc_runtime_Text_charTab__A+8047) /* __name */
    },
};
