...
/* --> BLUE_Toggle */
extern xdc_Void BLUE_Toggle(xdc_UArg);
...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[7148];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/csxwin/workspace_v6.1.2/LAB7CLK/Debug/configPkg/package/cfg/empty_min_pem4f");
...
ti_sysbios_knl_Clock_Object__ ti_sysbios_knl_Clock_Object__table__V[1] = {
    {/* instance#0 */
        ...
        1,  /* active */
        ((xdc_Void(*)(xdc_UArg))((xdc_Fxn)BLUE_Toggle)),  /* fxn */
        ((xdc_UArg)0),  /* arg */
    },
};
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1bec;
